...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      "inline-block text-sm  rounded-full border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 focus:bg-stone-300 hover:text-stone-500 focus:outline-none focus:ring focus:ring-stone-300 focus:ring-offset-2 focus:text-stone-500 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5",
  };
